class NewModel {
  ...
  NewModel({bool success, List<NewData> data}) {
  ...
  List<NewData> get data => _data;
  set data(List<NewData> data) => _data = data;

  NewModel.fromJson(Map<String, dynamic> json) {
    _success = json['success'];
    if (json['data'] != null) {
      _data = new List<NewData>();
      json['data'].forEach((v) {
        _data.add(new NewData.fromJson(v));
      });
    }
  }
