class RecommendModel {
  bool _success;
  List<RecommendData> _data;

  RecommendModel({bool success, List<RecommendData> data}) {
  ...
  List<RecommendData> get data => _data;
  set data(List<RecommendData> data) => _data = data;

  RecommendModel.fromJson(Map<String, dynamic> json) {
    _success = json['success'];
    if (json['data'] != null) {
      _data = new List<RecommendData>();
      json['data'].forEach((v) {
        _data.add(new RecommendData.fromJson(v));
      });
    }
  }
